...
const Cart = () => {
  ...
  const bitcointvalue = totalPrice/2000000;


  // Setbitcoin(bitcointvalue)
    ...
    try {
      ...
      if (response.data.Cuponcode[0]?.cupon[0]?.discountAmount) {
        ...
        if (coupon && coupon.discountAmount) {
          ...
          console.log(newTotal/2000000 , "getting bit coin")

          Setbitcoin(newTotal/2000000)
            ...
            <div className="mx-auto mt-8 max-w-md md:mt-12">
              <div className="rounded-3xl bg-white shadow-lg">
                <div className="px-4 py-6 sm:px-8 sm:py-10">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    <p className="text-sm font-medium text-gray-900">Bit Coin</p>
                    <p className="text-2xl font-semibold text-gray-900">
                      <span className="text-xs font-normal text-gray-400">BTC</span>{" "}
                      ₿ {bitcoin}
                    </p>
                  </div>
